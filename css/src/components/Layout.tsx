      ...
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-slate-500">Demo Explorer</p>
          </div>

          <nav className="ml-4 flex items-center gap-1 rounded-lg bg-slate-100/80 p-1">
            <TabLink to="/" end>
              Surveys
            </TabLink>
            <TabLink to="/fill">Fill the Survey</TabLink>
          </nav>
