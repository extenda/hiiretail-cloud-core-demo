...
export type PatchCustomerByExternalIdDto = {
    ...
    creditLimit?: CreditLimitDto;
    /**
     * External customer identifier used to locate the record. This field is a lookup key and cannot be changed.
     */
    externalCustomerId: string;
    /**
     * Business unit scope key used to locate the record. This field is a lookup key and cannot be changed.
     */
    businessUnitGroup?: string;
};
...
export type PatchProjectByExternalIdDto = {
    ...
    toDate?: string;
    /**
     * External project identifier used to locate the record. This field is a lookup key and cannot be changed.
     */
    externalProjectId: string;
    /**
     * External customer identifier used to locate the record. This field is a lookup key and cannot be changed.
